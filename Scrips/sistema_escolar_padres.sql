...
CREATE TABLE `padres` (
  ...
  KEY `idx_padres_usuario` (`id_usuario`),
  CONSTRAINT `padres_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-12-10 11:45:11
