...
CREATE TABLE `profesores` (
  ...
  KEY `idx_profesores_usuario` (`id_usuario`),
  CONSTRAINT `profesores_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-12-10 11:45:19
